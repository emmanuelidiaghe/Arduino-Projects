...
void setup() 
{
  ...
  virtuino.connectESP8266_toInternet("ILIAS NETWORK","6973403792",8000);  // Set your home wifi router SSID and PASSWORD. ESP8266 will connect to Internet. Port=80
  virtuino.esp8266_setIP(192,168,2,150);                                          // Set a local ip. Forward port 80 to this IP on your router
